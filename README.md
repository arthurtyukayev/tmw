...
3.  Commands
   ...
   init NAME --type=TYPE --backend=PATH [--frontend=PATH]
      ...
      Examples:
         tmw init allcore --type=fullstack \
              --backend=~/Projects/allcore-backend \
              --frontend=~/Projects/allcore-frontend
         tmw init mini-tv --type=single --backend=~/Projects/mini-tv
